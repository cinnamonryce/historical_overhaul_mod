...
NCountry = {
	...
	NAT_FOCUS_YEARS = 10,							-- years before you can change focus again. NEW! - down to 10 from 25
	...
	CORE_LOSE_CULTURE_GROUP =200,					-- how many years until a core in a country's culture group is lost. NEW! - up to 200 from 150
	...
	POPULATION_GROWTH = 0.01, 						-- _CDEF_POPULATION_GROWTH_; Base population growth. NEW! - down to 0.01 from 0.03
	...
	MAX_EXTRA_PERSONALITIES = 3,					-- Number of personalities that can be gained except the one you get when turning 15. Changed - up to 3 from 2
	...
	INITIAL_REGULAR_COLONY = 5, -- NEW! - down to 5 from 10
	REGULAR_COLONY_GROWTH = 10, -- NEW! - down to 10 from 25
	COLONIAL_CLAIM_BONUS = 10,
	COLONIAL_CLAIM_VIOLATION = -20,
	COLONY_VIOLAION_PAPAL_INFLUENCE_COST  = -10,
	COLONIAL_NATION_GROWTH_IMPACT = 0.5,			-- colonies of colonial nations grow slower if desired. -- NEW! - down to 0.5 from 1
	...
	CAN_CONVERT_TERRITORY_CULTURE = 0, -- Defines if you are allowed to culture convert territory provinces. -- NEW! - disabled from vanilla
	...
	SETTLMENT_GROWTH_CHANCE_MIN = 0.1, -- Minimum chance of increasing development for colonists promoting Settlement Growth. -- NEW! - up to 0.1 from 0.05
	SETTLEMENT_GROWTH_CHECK_INTERVAL = 183, -- Interval in days between checks for random development increase when working in Settlement Growth. -- NEW! - down to 183 days from 365
	...
	TRIBE_SETTLE_ADM_COST = 250, -- NEW! Up to 250 from 50.
	TRIBE_SETTLE_DIP_COST = 250, -- NEW! Up to 250 from 50.
	TRIBE_SETTLE_MIL_COST = 250, -- NEW! Up to 250 from 50.
...
NReligion = {
	...
	MAX_RELIGIOUS_CENTER_SPREAD_DISTANCE = 1000.0,				-- When spreading the religion to other provinces the distance wont exceed this number. --NEW! - up to 1000 from 150.
	...
	REFORM_DESIRE_PER_YEAR = 0.0025, -- Increase of reform descire for each year. -- NEW! Up to 0.0025 from 0.002
